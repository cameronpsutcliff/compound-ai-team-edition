...
1. **Shells inherit, do not redefine.** Use the the kit design system from `../tier-1-global/design-system/`.
...
- **Up further:** `../tier-1-global/design-system/` for the kit tokens that style every shell
