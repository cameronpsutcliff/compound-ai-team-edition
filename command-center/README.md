...
If your capability-profile.md has `scheduled_agents: true`, you can wire refresh.py to a system timer (cron, launchd, Task Scheduler) so the dashboard rebuilds automatically whenever team-router updates task_state.json.
