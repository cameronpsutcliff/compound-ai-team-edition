...
This file is public and vendor-neutral by design. It must not carry private brand names, confidential source paths, or client-specific design language into generated deliverables.
...
The agent-facing kit stays focused on how to behave and what to build, with no product-specific context.
