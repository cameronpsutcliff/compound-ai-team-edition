...
WEBSITE_PUBLIC="/path/to/your-site/public/compound-ai"
...
# a deployed-build inspection; for local dev, read <your-field-guide-component>)
BADGE_VERSION=$(grep -oE 'KIT_VERSION\s*=\s*'\''v[0-9]+\.[0-9]+\.[0-9]+'\''' \
  /path/to/<your-field-guide-component> | grep -oE 'v[0-9]+\.[0-9]+\.[0-9]+')
...
RELEASE_URL_VERSION=$(grep -oE 'releases/tag/v[0-9]+\.[0-9]+\.[0-9]+' \
  /path/to/<your-page-component> | head -1 | sed 's|releases/tag/||')
