...
In one build, several decisions emerged mid-execution that the
ratified plan did not anticipate. One incident is the canonical example: the panel ratified a foreword
structure but did not lock the specific opening example. During
...
- **With escalation:** the agent flags the decision, the operator runs
  a mini-panel, the panel converges on
  a single opening example, the foreword ships once.

That debate was the escalation discipline working. It surfaced a
